	...
	return new Promise((resolve) => {
		...
		if (verticesData) {
			...
			for (let i = 0; i < verticesFloatArray.length; i += 3) {
				...
				// I originally thought this would be verticesMax[2] / 2 as you would move from the center to the bottom
				// But when testing it shows lower than the reference apple.obj model (which was confirmed to be correct)
