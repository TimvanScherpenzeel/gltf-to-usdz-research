...
function constructOBJ({
 vertices, uvs, normals, indices,
	...
	return new Promise((resolve) => {
		...
		// console.log(Float32Array.from(vertices));

		// const verticesDataView = new DataView(vertices);

		// // vertices: Float32Array; (3)
		// for (let i = 0; i < vertices.length; i += 3) {
		// 	const x = verticesDataView.getFloat32(i);
		// 	const y = verticesDataView.getFloat32(i + 1);
		// 	const z = verticesDataView.getFloat32(i + 2);
