...
function constructOBJ({
 vertices, uvs, normals, indices,
	...
	return new Promise((resolve) => {
		...
		// 	const uintArray = new Uint16Array(data.length / 4);
		// 	let byteOffset = 0;
		...
		// console.log(indicesFloatArray);

		// for (let i = 0; i < indicesFloatArray.length; i += 3) {
		// 	const ix = indicesFloatArray[i];
		// 	const iy = indicesFloatArray[i + 1];
		// 	const iz = indicesFloatArray[i + 2];
		// 	const x = vertices[ix];
		// 	const y = vertices[iy];
		// 	const z = vertices[iz];
